...
public class Client_GUI extends Frame {
	...
	public Client_GUI() {
		...
		this.setTitle("ADRELI - Client"); // Fenstertitel
		...
		MenuItem datei_loeschen = new MenuItem("Datei löschen");
	...
	public void menu() {
		...
		if (verbindung == true) {
			...
			server.setBounds(50, 120, 350, 10);
			port.setBounds(50, 135, 350, 10);
			...
			JMenuItem datei_loeschen = new JMenuItem("Datei loeschen");
	...
	public void paint(Graphics g) {
		...
		// Footer
		g.drawString("ADRELI_4 © 2017", 500, this.getHeight() - 35);
	...
	public void verbinden() {
		...
		port_l.setBounds(50, 125, 150, 20);
		port_l.setVisible(true);
		this.add(port_l);
		// TextField Port
		final TextField port_t = new TextField();
		port_t.setBounds(200, 125, 120, 20);
	...
	public void records_auflisten() {
		...
		if (Client_Funktion.personen.isEmpty()) {
			...
			// TextField Name
			final TextField name_t = new TextField();
			name_t.setBounds(200, 100, 175, 20);
			...
			// TextField Vorname
			final TextField vorname_t = new TextField();
			vorname_t.setBounds(200, 125, 175, 20);
			...
			// TextField Anrede
			final TextField anrede_t = new TextField();
			anrede_t.setBounds(200, 150, 175, 20);
			...
			// TextField Strasse
			final TextField strasse_t = new TextField();
			strasse_t.setBounds(200, 175, 175, 20);
			...
			// TextField PLZ
			final TextField plz_t = new TextField();
			plz_t.setBounds(200, 200, 175, 20);
			...
			// TextField Ort
			final TextField ort_t = new TextField();
			ort_t.setBounds(200, 225, 175, 20);
			...
			// TextField Telefon
			final TextField telefon_t = new TextField();
			telefon_t.setBounds(200, 250, 175, 20);
			...
			// TextField Fax
			final TextField fax_t = new TextField();
			fax_t.setBounds(200, 275, 175, 20);
			...
			// TextField Bemerkung
			final TextField bemerkung_t = new TextField();
			bemerkung_t.setBounds(200, 300, 175, 20);
	...
	public void datei_loeschen() throws Fehler_Exception {
		...
		this.removeAll(); // Fesnter leeren
		headline("Datei löschen"); // Überschrift

		checkConnection(); // Ist Server noch aktiv ?

		JaNein_Dialog dlg = new JaNein_Dialog(null, "Datei löschen",
		...
		if (dlg.getAntwort() == true) { // Drücken von JA
			...
			if (Client_Funktion.error == false) {
				Label text1;
				text1 = new Label("Datei wurde erfolgreich von dem "
						+ "Server gelöscht.");
				text1.setBounds(50, 100, 350, 20);
				text1.setVisible(true);
				this.add(text1);
			...
			Label text1;
			text1 = new Label("Datei wurde nicht gelöscht.");
			text1.setBounds(50, 100, 350, 20);
			text1.setVisible(true);
			this.add(text1);
		}
